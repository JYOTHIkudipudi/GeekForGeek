...
You need to transform the stones into a pyramid by only reducing the heights of the stones. Reducing the height of a stone by 1 costs 1 unit, 
and stones cannot be increased or moved.
...
public:
    int formPyramid(vector<int>& arr) {
        ...
        // Find the largest possible pyramid peak
        int peak = 0;
        ...
        // Minimum cost = total stones - stones remaining in pyramid
        long long total = 0;
        ...
        // Sum of pyramid:
        // 1 + 2 + ... + peak + ... + 2 + 1
        long long pyramidSum = 1LL * peak * peak;
